...
class DivideSKNet_DoubleSwinTransformer(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        super(DivideSKNet_DoubleSwinTransformer, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(DivideSKNet_DoubleSwinTransformer, self).train(mode)
        self._freeze_stages()
