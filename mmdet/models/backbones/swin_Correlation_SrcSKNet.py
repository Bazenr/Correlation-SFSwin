...
class Corr_SrcSKNet_SwinTransformer(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        super(Corr_SrcSKNet_SwinTransformer, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(Corr_SrcSKNet_SwinTransformer, self).train(mode)
        self._freeze_stages()
