...
# 普通双主干SwinTransformer
@MODELS.register_module()
class DoubleSwinTransformer(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        super(DoubleSwinTransformer, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(DoubleSwinTransformer, self).train(mode)
        self._freeze_stages()
    ...
    def forward(self, x):
        ...
        for i in range(len(outs_RGB)):
            ...
            # outs.append(concat_out)

            concat_outs.append(torch.concat((outs_RGB[i],
                                             outs_HSI[i]), dim=1))
