...
class DetFusionDataPreprocessor(BaseDataPreprocessor):
    """Fusion img pre-processor for normalization and bgr to rgb conversion.
    """
    def __init__(self,
                 ...
                 # from class DetDataPreprocessor(ImgDataPreprocessor)
                 pad_mask: bool = False,
    ...
    def super_forward(self, data: dict, training: bool = False) -> Union[dict, list]:
    ...
    def forward(self, data: dict, training: bool = False) -> dict:
        ...
        data = self.super_forward(data=data, training=training)
